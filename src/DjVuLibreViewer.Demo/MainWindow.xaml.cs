...
namespace DjVuLibreViewer.Demo
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public MainWindow()
        {
            ...
            Title = $"WPF DjVuLibre Viewer Demo v{version}";
            ...
            /* TODO Search
            SearchManager = new DjVuSearchManager(Renderer);
        ...
        private async void RenderToMemory(object sender, RoutedEventArgs e)
        {
            try
            {
                var pageStep = Renderer.PagesDisplayMode == DjVuPagesDisplayMode.BookMode ? 2 : 1;
        ...
        private void OpenDjVu(object sender, RoutedEventArgs e)
        {
            var dialog = new OpenFileDialog
            {
                Filter = "DjVu Files (*.djvu)|*.djvu|All Files (*.*)|*.*",
                Title = "Open DjVu File"
            };
            ...
            if (dialog.ShowDialog() == true)
            {
                // TOOD ResetSearch();
                // TOOD ResetBookmarks();
                // TOOD ResetThumbnails();

                Renderer.OpenDjVu(dialog.FileName);
        ...
        protected override void OnClosed(EventArgs e)
        {
            ...
            MemoryChecker?.Stop();
            Renderer?.Dispose();
            // TODO ThumbnailRenderer?.Dispose();
            // TODO _thumbnailFilename = null;
        }
        ...
        {
            Renderer.ZoomMode = DjVuZoomMode.FitWidth;
        }

        private void OnFitHeight(object sender, RoutedEventArgs e)
        {
            Renderer.ZoomMode = DjVuZoomMode.FitHeight;
        }
        ...
        private void OnGetText(object sender, RoutedEventArgs e)
        {
            ...
            txtViewer.Body = Renderer.GetDjVuText(page);
        ...
        {
            Renderer.PagesDisplayMode = DjVuPagesDisplayMode.ContinuousMode;
        }

        private void OnBookModeClick(object sender, RoutedEventArgs e)
        {
            Renderer.PagesDisplayMode = DjVuPagesDisplayMode.BookMode;
        }

        private void OnSinglePageModeClick(object sender, RoutedEventArgs e)
        {
            Renderer.PagesDisplayMode = DjVuPagesDisplayMode.SinglePageMode;
        }
        ...
        private async void OnCloseDjVu(object sender, RoutedEventArgs e)
        {
            try
            {
        ...
        private void EnableHandTools(object sender, RoutedEventArgs e)
        {
            ...
            Renderer.CursorMode = toggle.IsChecked == true ? DjVuCursorMode.Pan : DjVuCursorMode.TextSelection;
        }
        ...
        private DjVuSearchManager SearchManager { get; }
        ...
        */
        ...
        public DjVuBookmarkCollection Bookmarks { get => _bookmarks; set => SetProperty(ref _bookmarks, value); }
        private DjVuBookmarkCollection _bookmarks;

        private void BookmarkTree_SelectedItemChanged(object sender, RoutedPropertyChangedEventArgs<object> e)
        {
            DjVuBookmark selectedBookmark = BookmarkTree.SelectedItem as DjVuBookmark;
        ...
        private void ShowThumbnails()
        {
            ...
            {
                ThumbnailRenderer.OpenDjVu(new FileStream(_thumbnailFilename, FileMode.Open, FileAccess.Read, FileShare.Read));
                ThumbnailRenderer.PagesDisplayMode = DjVuPagesDisplayMode.ContinuousMode;
                ThumbnailRenderer.ZoomMode = DjVuZoomMode.FitWidth;
                ThumbnailRenderer.IsZoomAllowed = false;
                ThumbnailRenderer.CursorMode = DjVuCursorMode.Pan;
        ...
        */
        ...
        {
            var djvuDocument = Renderer.Document;
            if (djvuDocument == null) return;

            using (var printDialog = new System.Windows.Forms.PrintDialog())
            using (var printDocument = djvuDocument.CreatePrintDocument())
            {
                printDialog.AllowSomePages = true;
                printDialog.Document = printDocument;
                printDialog.UseEXDialog = true;
                printDialog.Document.PrinterSettings.FromPage = 1;
                printDialog.Document.PrinterSettings.ToPage = djvuDocument.PageCount;
                ...
                if (printDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    try
                    {
                        if (printDialog.Document.PrinterSettings.FromPage <= djvuDocument.PageCount)
                        {
