...
{
    internal class DjVuPrintDocument : PrintDocument
    {
        private readonly IDjVuDocument _document;
        private readonly DjVuPrintSettings _settings;
        ...
        public DjVuPrintDocument(IDjVuDocument document, DjVuPrintSettings settings)
        {
        ...
        private void PrintSinglePage(PrintPageEventArgs e)
        {
            if (_currentPage < _document.PageCount)
            {
                ...
                if (_settings.Mode == DjVuPrintMode.ShrinkToMargin)
                {
                    left = 0;
                    top = 0;
