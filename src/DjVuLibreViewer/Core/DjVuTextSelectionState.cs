...
{
    public class DjVuTextSelectionState
    {
        ...
        public DjVuTextSelectionState GetNormalized()
        {
                ...
                (StartPage == EndPage && EndIndex < StartIndex))
            {
                ...
                return new DjVuTextSelectionState()
                {
        ...
        /// <returns></returns>
        public static DjVuTextSelectionState Merge(DjVuTextSelectionState src1, DjVuTextSelectionState src2)
        {
            var result = new DjVuTextSelectionState();
